...
public class StoreUtils {
    ...
    public static String getSystemStore(Context context) {
        return getStoreSdCardFirst(context) + "/" + "easyClass/";
    }

    private static String getStoreSdCardFirst(Context context) {
    ...
    private static String getSDCardPathCompatible(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ECLAIR) {
            String[] files = getExtSDCardPath(context);
            Z:
